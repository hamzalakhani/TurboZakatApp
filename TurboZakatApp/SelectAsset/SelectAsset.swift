...
//  TurboZakatApp
//
//  Created by Hamza Lakhani on 2018-02-15.
...
enum RegistrationStates {
    case MainPage
    case MultipleSingle
    case SelectMultipleAssets
    case SelectSingleAsset
    case FinalZakat
}
...
class SelectAsset: UIViewController {
...
//
        ...
        override func viewDidLoad() {
            ...
            // for multiple asset selection screen
